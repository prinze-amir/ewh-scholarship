...
const ApplyForm = () => {
  ...
  useEffect(() => {
    setAccentColor(localStorage.getItem('theme-accent-color') || themeAccentColor);
  }, [])
  ...
  if (loading) {
      return (
        ...
        <Skeleton isLoaded={!loading} height="50vh" width="50vw">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-lg">
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full px-3">
              ...
              <input className="appearance-none block w-full bg-gray-200  border  rounded py-3 px-4 mb-3 leading-tight text-gray-700 focus:outline-none focus:bg-white" id="addressCity" type="text" required placeholder="City"/>
            </div>
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
              <label className="block uppercase tracking-wide text-xs font-bold mb-2" htmlFor="addressState">
                State
              </label>
              <input className="appearance-none block w-full bg-gray-200  border  rounded py-3 px-4 mb-3 leading-tight text-gray-700 focus:outline-none focus:bg-white" id="addressState" type="text" required placeholder="State"/>
            </div>
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
              <label className="block uppercase tracking-wide text-xs font-bold mb-2" htmlFor="addressZip">
                Zipcode
              </label>
              <input className="appearance-none block w-full bg-gray-200  border  rounded py-3 px-4 mb-3 leading-tight text-gray-700 focus:outline-none focus:bg-white" id="addressZip" type="text" required placeholder="Zipcode"/>
            </div>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <select className="appearance-none block w-full bg-gray-200  border  rounded py-3 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white" id="year" required placeholder={year}>
                {
