...
export default function RecipientCard ({recipient}) {
    ...
    const imageUrl = recipient.profileImage ? recipient.profileImage.src : defaultProfile;
    ...
    return (
        <div className={style.recipientView}>
                    ...
                    {session && <p className="text-lg font-bold">Amount Received: $ {recipient?.amountReceived || '0.00'}</p>}
                    </div>
